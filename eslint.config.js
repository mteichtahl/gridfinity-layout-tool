...
export default defineConfig([
  globalIgnores(['dist', 'coverage', 'e2e', 'scripts', 'benchmarks', '.stryker-tmp', 'reports', 'playwright.config.ts', 'playwright.smoke.config.ts', 'playwright-ct.config.ts', 'playwright', '**/*.visual.tsx']),
  {
    files: ['**/*.{ts,tsx}'],
    extends: [
