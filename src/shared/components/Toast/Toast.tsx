  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-1/2 -translate-y-1/2 right-2 p-1 flex items-center justify-center rounded-md text-current opacity-60 hover:opacity-100 hover:bg-white/10 transition-all"
