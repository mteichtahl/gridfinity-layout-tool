...
vi.mock('@/shared/utils/stlSearch', () => ({
  openSTLSearch: vi.fn(),
...
describe('STLSearchDropdown', () => {
          ...
          stlSearchSites: [
            {
              ...
              name: 'Thangs',
              enabled: true,
              urlTemplate: 'https://thangs.com/{query}',
            },
            {
              id: 'printables',
              name: 'Printables',
              enabled: true,
              urlTemplate: 'https://printables.com/{query}',
            },
          ],
        },
      };
  ...
  it('renders nothing when no sites are enabled', () => {
    vi.mocked(useSettingsStore).mockImplementation((selector: unknown) => {
      const state = {
        settings: {
          stlSearchSites: [{ id: 'thangs', name: 'Thangs', enabled: false, urlTemplate: '' }],
        },
      };
      return (selector as (s: typeof state) => unknown)(state);
    });
