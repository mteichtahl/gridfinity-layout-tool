 ...
 * export contract here; sizing logic is covered in `cutoutLabelFit.test.ts`,
 * placement in `@/shared/utils/cutoutLabel.test.ts`, and color in
 * `cutoutLabelColor.test.ts`.
 */
