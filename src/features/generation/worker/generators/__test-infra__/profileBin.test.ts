 ...
 *
 * Run with brepkit:
 *   BREPJS_KERNEL=brepkit npx vitest run --reporter=verbose src/features/generation/worker/generators/__test-infra__/profileBin.test
 *
 * Run with OCCT (baseline):
 *   npx vitest run --reporter=verbose src/features/generation/worker/generators/__test-infra__/profileBin.test
 */
