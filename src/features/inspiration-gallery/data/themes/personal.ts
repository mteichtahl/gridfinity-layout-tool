...
function createBathroomMakeup(): InspirationLayout {
  ...
  const layout: Layout = {
    ...
    drawer: { width: gridUnits(6), depth: gridUnits(8), height: heightUnits(6) },
    printBedSize: mm(256),
    gridUnitMm: mm(42),
    heightUnitMm: mm(7),
    categories,
...
function createNightstandDrawer(): InspirationLayout {
  ...
  const layout: Layout = {
    ...
    drawer: { width: gridUnits(6), depth: gridUnits(6), height: heightUnits(6) },
    printBedSize: mm(256),
    gridUnitMm: mm(42),
    heightUnitMm: mm(7),
    categories,
...
function createFirstAidKit(): InspirationLayout {
  ...
  const layout: Layout = {
    version: '1.0',
    name: 'First Aid Kit',
    drawer: { width: gridUnits(7), depth: gridUnits(7), height: heightUnits(6) },
    printBedSize: mm(256),
    gridUnitMm: mm(42),
    heightUnitMm: mm(7),
    categories,
...
function createJewelryDrawer(): InspirationLayout {
  ...
  const layout: Layout = {
    version: '1.0',
    name: 'Jewelry Drawer',
    drawer: { width: gridUnits(8), depth: gridUnits(6), height: heightUnits(6) },
    printBedSize: mm(256),
    gridUnitMm: mm(42),
    heightUnitMm: mm(7),
    categories,
