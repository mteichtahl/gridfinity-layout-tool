...
export type BaseplateDesignId = string & { readonly __brand: 'BaseplateDesignId' };
...
/** Brand a raw string as a BaseplateDesignId. Use at system boundaries (deserialization, user input). */
export const baseplateDesignId = (id: string): BaseplateDesignId => id as BaseplateDesignId;
